...
from app.models.user import UserModel, UserRoleModel
...
class Register(MethodView):
    def post(self):
        ...
        role = UserRoleModel.query.get(role_id)

        if not role or role.id == 3:
        ...
        user = UserModel(
            email=email, password=hashed_pass, full_name=full_name, role_id=role_id
        )
